...
/*   Updated: 2018/12/15 20:16:19 by bcozic           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_section_32(uint8_t *ptr, uint32_t addr, t_data *data, uint32_t size)
{
	uint32_t	i;
...
void	print_section_64(uint8_t *ptr, uint64_t addr, t_data *data, uint64_t size)
{
	uint64_t	i;
